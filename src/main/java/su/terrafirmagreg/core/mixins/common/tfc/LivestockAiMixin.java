...
public class LivestockAiMixin {
     ...
     * Without this mixin livestock has a 2 in 3 chance to go on a walk, 1 in 3 to do nothing for 30 to 60 ticks.
     * With this mixin DoNothing has an 11 in 13 chance.
     */
