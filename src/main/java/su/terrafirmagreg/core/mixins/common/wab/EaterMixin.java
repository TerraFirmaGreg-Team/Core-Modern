...
public abstract class EaterMixin extends Animal {
    ...
    /**
     * overrides Eater goals with our own
     * @author Pyritie
     * @reason remove unneeded goals to attack villagers, raiders, and animals
     */
	...
	protected void registerGoals()
	{
        ...
        // gotta be careful here, super in this case is a minecraft class so registerGoals() gets obfuscated
		super.registerGoals();
