...
public class NetworkSenderConfigEntry {
    ...
    @Getter
    @Setter
    private NetworkSenderConfigEntry.TriggerMode currentSendTrigger = NetworkSenderConfigEntry.TriggerMode.ITEM;
    @Getter
    @Setter
    ...
    public NetworkSenderConfigEntry(CompoundTag tag) {
        ...
        currentSendTrigger = NetworkSenderConfigEntry.TriggerMode.values()[tag.getInt("currentSendTrigger")];
