...
public class NetworkReceiverConfigEntry {
    ...
    @Getter
    @Setter
    private NetworkReceiverConfigEntry.LogicMode currentMode;
    @Getter
    @Setter
    ...
    public NetworkReceiverConfigEntry(int inv) {
        ...
        currentCooldown = 0;
        currentMode = NetworkReceiverConfigEntry.LogicMode.COOLDOWN;

    }

    public NetworkReceiverConfigEntry(CompoundTag tag) {
        distinctInventory = tag.getInt("circuit");
        currentMode = NetworkReceiverConfigEntry.LogicMode.values()[tag.getInt("currentMode")];
