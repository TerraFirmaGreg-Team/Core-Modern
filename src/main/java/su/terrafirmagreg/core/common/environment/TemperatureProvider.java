...
/**
 * Lightweight temperature provider that uses a sphere (bubble) around the machine.
...
public class TemperatureProvider {
    ...
    public TemperatureProvider(BlockPos machinePos, int radius) {
    ...
    public static TemperatureProvider load(CompoundTag tag) {
        ...
        return new TemperatureProvider(pos, radius);
    }
}
