...
public final class TFGSounds {
    ...
    public static final TFCSounds.EntitySound SLIME = new TFCSounds.EntitySound(() -> SoundEvents.SLIME_SQUISH_SMALL, () -> SoundEvents.SLIME_DEATH_SMALL, () -> SoundEvents.SLIME_HURT_SMALL, () -> SoundEvents.EMPTY,
