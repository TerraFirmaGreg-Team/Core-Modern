...
/**
 * Basically a copy of the vanilla Chorus Plant except that it grows on any rock/cobble/gravel/sand
...
public class LunarChorusPlantBlock extends ChorusPlantBlock {
	...
	public BlockState getStateForPlacement(BlockGetter pLevel, BlockPos pPos) {
		...
		return this.defaultBlockState()
				   .setValue(DOWN, below.is(this) || below.is(lunarChorusFlower) || LunarChorusFlowerBlock.isGroundBlock(below))
