...
//				.register());
	...
	public static final MultiblockMachineDefinition ELECTRIC_GREENHOUSE = REGISTRATE.multiblock("electric_greenhouse", GreenhouseMachine::new)
		...
		.pattern(definition -> {
			...
			TraceabilityPredicate importHatch = Predicates.abilities(PartAbility.IMPORT_FLUIDS).or(Predicates.blocks(GTAEMachines.FLUID_IMPORT_HATCH_ME.get())).setExactLimit(1);
