...
public class StromatoliteClusterSmallBlock extends Block {

	protected static final VoxelShape SHAPE = Block.box(2.0F, 0.0F, 2.0F, 14.0F, 6.0F, 14.0F);


	public StromatoliteClusterSmallBlock(Properties pProperties) {
		super(pProperties);
	}
