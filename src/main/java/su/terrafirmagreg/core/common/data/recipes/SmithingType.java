...
public class SmithingType {
    ...
    public SmithingType(String name, ItemStack inputItemA, TagKey<Item> toolA, TagKey<Item> toolB, ResourceLocation activeTexture, ResourceLocation inactiveTexture, SoundEvent clickSound) {
        this(name, inputItemA, ItemStack.EMPTY, toolA, toolB, activeTexture, inactiveTexture, clickSound);
    }

    public SmithingType(String name, ItemStack inputItemA, TagKey<Item> toolA, TagKey<Item> toolB, ResourceLocation activeTexture, SoundEvent clickSound) {
        this(name, inputItemA, ItemStack.EMPTY, toolA, toolB, activeTexture, null, clickSound);
    }

    public SmithingType(String name, ItemStack inputItemA, ItemStack inputItemB, TagKey<Item> toolA, TagKey<Item> toolB, ResourceLocation activeTexture, SoundEvent clickSound) {
        this(name, inputItemA, inputItemB, toolA, toolB, activeTexture, null, clickSound);
    }
    ...
    public static ArrayList<SmithingType> SMITHING_TYPES = new ArrayList<>();
    ...
    static {
        SMITHING_TYPES.add(CASTING_MOLD);
        SMITHING_TYPES.add(EXTRUDER_MOLD);
        SMITHING_TYPES.add(RESIN_BOARD);
    }
}
