...
public class LightSmokeEmitterDecorationBlock extends Block {

	public static final VoxelShape DEFAULT_SHAPE = Block.box(2.0F, 0.0F, 2.0F, 14.0F, 16.0F, 14.0F);
	private final VoxelShape shape;

	public LightSmokeEmitterDecorationBlock(Properties pProperties, VoxelShape shape, Supplier<Item> itemSupplier) {
		super(pProperties);
        this.shape = shape;
    }
