...
public class InterplanetaryLogisticsMonitorMachine extends MetaMachine implements IMuiMachine {
    public InterplanetaryLogisticsMonitorMachine(BlockEntityCreationInfo info) {
        super(info);
    }
