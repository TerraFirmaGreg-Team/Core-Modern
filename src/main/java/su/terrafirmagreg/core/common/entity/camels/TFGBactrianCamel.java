...
public class TFGBactrianCamel extends TFGAbstractCamel implements HorseProperties, IForgeShearable {
    ...
    static {
        GENDER = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityDataSerializers.BOOLEAN);
        BIRTHDAY = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityHelpers.LONG_SERIALIZER);
        FAMILIARITY = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityDataSerializers.FLOAT);
        USES = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityDataSerializers.INT);
        FERTILIZED = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityDataSerializers.BOOLEAN);
        OLD_DAY = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityHelpers.LONG_SERIALIZER);
        GENETIC_SIZE = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityDataSerializers.INT);
        LAST_FED = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityHelpers.LONG_SERIALIZER);
        ANIMAL_DATA = new CommonAnimalData(GENDER, BIRTHDAY, FAMILIARITY, USES, FERTILIZED, OLD_DAY, GENETIC_SIZE, LAST_FED);
        PREGNANT_TIME = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityDataSerializers.LONG);
        DATA_PRODUCED = SynchedEntityData.defineId(TFGBactrianCamel.class, EntityDataSerializers.LONG);
    }
}
