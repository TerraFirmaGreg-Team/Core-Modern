...
public class TFCDromedaryCamel extends TFCAbstractCamel implements HorseProperties {
    ...
    public boolean canMate(Animal otherAnimal) {
        if (otherAnimal.getClass() != this.getClass())
            return false;
        TFCDromedaryCamel other = (TFCDromedaryCamel) otherAnimal;
    ...
    public boolean checkExtraBreedConditions(TFCAnimalProperties otherAnimal) {
        if (otherAnimal instanceof TFCDromedaryCamel otherCamel) {
    ...
    @Nullable
    @Override
    public TFCDromedaryCamel getBreedOffspring(ServerLevel level, AgeableMob other) {
        final AgeableMob mob = super.getBreedOffspring(level, other);
        return mob instanceof TFCDromedaryCamel camel ? camel : null;
    }
    ...
    static {
        GENDER = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityDataSerializers.BOOLEAN);
        BIRTHDAY = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityHelpers.LONG_SERIALIZER);
        FAMILIARITY = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityDataSerializers.FLOAT);
        USES = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityDataSerializers.INT);
        FERTILIZED = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityDataSerializers.BOOLEAN);
        OLD_DAY = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityHelpers.LONG_SERIALIZER);
        GENETIC_SIZE = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityDataSerializers.INT);
        LAST_FED = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityHelpers.LONG_SERIALIZER);
        ANIMAL_DATA = new CommonAnimalData(GENDER, BIRTHDAY, FAMILIARITY, USES, FERTILIZED, OLD_DAY, GENETIC_SIZE, LAST_FED);
        PREGNANT_TIME = SynchedEntityData.defineId(TFCDromedaryCamel.class, EntityDataSerializers.LONG);
    }
}
