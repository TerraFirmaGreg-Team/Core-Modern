...
import su.terrafirmagreg.core.common.data.blocks.SmokeEmitterDecorationBlock;

import java.util.function.Supplier;

@SuppressWarnings("unused")
public class SmokeEmitterDecorationBlockBuilder extends ExtendedPropertiesBlockBuilder {

	public transient VoxelShape cachedShape;
	public transient Supplier<Item> preexistingItem;
	public transient int rotate;

	public SmokeEmitterDecorationBlockBuilder(ResourceLocation i) {
		super(i);
	...
	public SmokeEmitterDecorationBlockBuilder withPreexistingItem(ResourceLocation item) {
		itemBuilder = null;
	...
	public SmokeEmitterDecorationBlockBuilder notAxisAligned() {
		rotate = 45;
		return this;
	}
	...
	public VoxelShape getShape() {
		if (customShape.isEmpty()) {
			return SmokeEmitterDecorationBlock.DEFAULT_SHAPE;
		}
		if (cachedShape == null) {
