...
public class TFGOreByProduct {
    ...
    public TFGOreByProduct(Material material) {
        ...
        if (ALWAYS_MACHINES == null) {
            ALWAYS_MACHINES = ImmutableList.of(
                    TFGMultiMachines.ORE_GRINDER.asStack(),
                    TFGMultiMachines.ORE_GRINDER.asStack(),
                    TFGMultiMachines.ORE_CENTRIFUGE.asStack(),
                    TFGMultiMachines.ORE_BATH.asStack(),
                    TFGMultiMachines.ORE_THERMAL_CENTRIFUGE.asStack(),
                    TFGMultiMachines.ORE_GRINDER.asStack(),
                    TFGMultiMachines.ORE_GRINDER.asStack(),
                    TFGMultiMachines.ORE_CENTRIFUGE.asStack());
        }
        ...
        oreStacks.add(ChemicalHelper.getTag(TFGTagPrefix.poorRawOre, material), 1, null);
        oreStacks.add(ChemicalHelper.getTag(TagPrefix.rawOre, material), 1, null);
        oreStacks.add(ChemicalHelper.getTag(TFGTagPrefix.richRawOre, material), 1, null);
        ...
        if (!washedIn.first().isNull()) {
            hasChemBath = true;
            addToInputs(TFGMultiMachines.ORE_BATH.asStack());
        } else {
            addToInputs(ItemStack.EMPTY);
        }
        ...
        if (material.hasProperty(PropertyKey.GEM)) {
            hasSifter = true;
            addToInputs(TFGMultiMachines.ORE_SIFTER.asStack());
        } else {
            addToInputs(ItemStack.EMPTY);
        }
