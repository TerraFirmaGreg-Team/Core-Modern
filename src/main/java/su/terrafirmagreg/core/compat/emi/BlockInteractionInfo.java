...
public class BlockInteractionInfo {
    ...
    public static BlockInteractionRecipe[] RECIPES = {
            ...
            new BlockInteractionRecipe("rustic_top", FLBlocks.CURED_OVEN_TOP.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_TOP.get(OvenType.RUSTIC).get().asItem(),
                    FLItems.FINISHES.get(OvenType.RUSTIC).get()),
            new BlockInteractionRecipe("rustic_bottom", FLBlocks.CURED_OVEN_BOTTOM.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_BOTTOM.get(OvenType.RUSTIC).get().asItem(),
                    FLItems.FINISHES.get(OvenType.RUSTIC).get()),
            new BlockInteractionRecipe("rustic_chimney", FLBlocks.CURED_OVEN_CHIMNEY.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_CHIMNEY.get(OvenType.RUSTIC).get().asItem(),
                    FLItems.FINISHES.get(OvenType.RUSTIC).get()),
            new BlockInteractionRecipe("rustic_hopper", FLBlocks.CURED_OVEN_HOPPER.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_HOPPER.get(OvenType.RUSTIC).get().asItem(),
                    FLItems.FINISHES.get(OvenType.RUSTIC).get()),
            ...
            new BlockInteractionRecipe("tile_top", FLBlocks.CURED_OVEN_TOP.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_TOP.get(OvenType.TILE).get().asItem(),
                    FLItems.FINISHES.get(OvenType.TILE).get()),
            new BlockInteractionRecipe("tile_bottom", FLBlocks.CURED_OVEN_BOTTOM.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_BOTTOM.get(OvenType.TILE).get().asItem(),
                    FLItems.FINISHES.get(OvenType.TILE).get()),
            new BlockInteractionRecipe("tile_chimney", FLBlocks.CURED_OVEN_CHIMNEY.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_CHIMNEY.get(OvenType.TILE).get().asItem(),
                    FLItems.FINISHES.get(OvenType.TILE).get()),
            new BlockInteractionRecipe("tile_hopper", FLBlocks.CURED_OVEN_HOPPER.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_HOPPER.get(OvenType.TILE).get().asItem(),
                    FLItems.FINISHES.get(OvenType.TILE).get()),
            ...
            new BlockInteractionRecipe("stone_top", FLBlocks.CURED_OVEN_TOP.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_TOP.get(OvenType.STONE).get().asItem(),
                    FLItems.FINISHES.get(OvenType.STONE).get()),
            new BlockInteractionRecipe("stone_bottom", FLBlocks.CURED_OVEN_BOTTOM.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_BOTTOM.get(OvenType.STONE).get().asItem(),
                    FLItems.FINISHES.get(OvenType.STONE).get()),
            new BlockInteractionRecipe("stone_chimney", FLBlocks.CURED_OVEN_CHIMNEY.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_CHIMNEY.get(OvenType.STONE).get().asItem(),
                    FLItems.FINISHES.get(OvenType.STONE).get()),
            new BlockInteractionRecipe("stone_hopper", FLBlocks.CURED_OVEN_HOPPER.get(OvenType.BRICK).get().asItem(), FLBlocks.CURED_OVEN_HOPPER.get(OvenType.STONE).get().asItem(),
                    FLItems.FINISHES.get(OvenType.STONE).get()),
