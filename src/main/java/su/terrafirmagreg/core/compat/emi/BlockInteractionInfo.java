...
public class BlockInteractionInfo {
    ...
    public static BlockInteractionRecipe[] RECIPES = {
            ...
            new BlockInteractionRecipe(incoloy_frame, copper_sandy_frame.get(), copper_sandy.get()),
            new BlockInteractionRecipe(incoloy_frame, beryllium_sandy_frame.get(), beryllium_sandy.get()),
            ...
            new BlockInteractionRecipe(copper_sandy_frame.get(), incoloy_frame, CustomTags.WIRE_CUTTERS),
            new BlockInteractionRecipe(beryllium_sandy_frame.get(), incoloy_frame, CustomTags.WIRE_CUTTERS),
    };
