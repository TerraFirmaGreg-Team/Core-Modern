...
public enum PhysicalDamageType implements StringRepresentable
{
    ...
    public static void addTooltipInfo(ItemStack stack, List<Component> tooltips)
    {
        ...
        // Damage resistance
        final Multiplier resistanceType = getResistanceForItem(stack);
    ...
    public static float calculateMultiplier(DamageSource source, Entity entityUnderAttack)
    {
        ...
        if (type != null)
        {
            ...
            final Multiplier naturalMultiplier = EntityDamageResistance.get(entityUnderAttack);
        ...
        {
            final Multiplier armorMultiplier = getResistanceForItem(stack);
    ...
    public static PhysicalDamageType.Multiplier getResistanceForItem(ItemStack stack)
    {
        ...
        if (stack.getItem() instanceof ArmorItem armor && armor.getMaterial() instanceof Multiplier armorMultiplier)
        {
