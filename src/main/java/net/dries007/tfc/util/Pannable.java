...
{
    public static final DataManager<Pannable> MANAGER = new DataManager<>(Helpers.identifier("panning"), "panning", Pannable::new, Pannable::new, Pannable::encode, Packet::new);
