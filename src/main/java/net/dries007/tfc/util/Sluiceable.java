...
{
    public static final DataManager<Sluiceable> MANAGER = new DataManager<>(Helpers.identifier("sluicing"), "sluicing", Sluiceable::new, Sluiceable::new, Sluiceable::encode, Packet::new);
