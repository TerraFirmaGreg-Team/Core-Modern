...
public enum Wood implements RegistryWood
{
    ...
    public enum BlockType
    {
        ...
        VERTICAL_SUPPORT(false, wood -> new VerticalSupportBlock(properties(wood).strength(1.0F).noOcclusion().flammableLikeLogs().isSuffocating((s, b, p) -> false))),
        HORIZONTAL_SUPPORT(false, wood -> new HorizontalSupportBlock(properties(wood).strength(1.0F).noOcclusion().flammableLikeLogs().isSuffocating((s, b, p) -> false))),
