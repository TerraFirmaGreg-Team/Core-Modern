...
public class Container extends AbstractContainerMenu
{
    ...
    /**
     * In {@link AbstractContainerMenu#doClick(int, int, ClickType, Player)} there is a call path through which {@link Slot#onTake(Player, ItemStack)} is not called. It just directly sets the slot, and the carried in the container.
