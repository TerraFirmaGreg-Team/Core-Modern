...
import static net.dries007.tfc.common.blocks.TFCBlockStateProperties.ATTACHED_WIND_DEVICES;
...
public class VaneBlockEntityRenderer implements BlockEntityRenderer<VaneBlockEntity>
{
    ...
    {
        this.model = new VaneModel(context.bakeLayer(RenderHelpers.modelIdentifier("vane")));
    }
