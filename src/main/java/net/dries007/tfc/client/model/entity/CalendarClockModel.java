...
public class CalendarClockModel extends Model
{
	...
	{
		static_parts.render(poseStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
		hour_hand.render(poseStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
		minute_hand.render(poseStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
		month_hand.render(poseStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}
