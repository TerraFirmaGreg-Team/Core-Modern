...
public final class ShoreNoise {
    ...
    public static ShoreNoiseSampler sandyBeach(Seed seed) {
        return new ShoreNoiseSampler() {
            final Noise2D tideLevelNoise = BiomeNoise.shoreTideLevelNoise(seed);
    ...
    public static ShoreNoiseSampler embayments(Seed seed) {
        return new ShoreNoiseSampler() {
            ...
            private final Noise2D tideLevelNoise = BiomeNoise.shoreTideLevelNoise(seed);
        ...
        return new ShoreNoiseSampler() {
            ...
            public double setColumnAndSampleHeight(double heightIn, int x, int z, double oceanWeight, double landWeight, double shoreWeight,
                ...
                final double cliffInfluence = Mth.clamp(
                        ...
                        0.0, 1.0);
				final double adjustedShoreWeight = getAdjustedShoreWeight(shoreWeight, cliffInfluence);
			...
			private static double getAdjustedShoreWeight(double shoreWeight, double cliffInfluence) {
				...
				// From [x2, 1.0], interpolate high shore weight, creates flatter area
				return shoreWeight < x2
