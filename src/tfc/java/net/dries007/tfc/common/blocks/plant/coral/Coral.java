...
public enum Coral
{
    ...
    public enum BlockType
    {
        ...
        BlockType(BiFunction<Coral, BlockType, ? extends Block> factory)
        {
            this(factory, BlockItem::new);
        }

        BlockType(BiFunction<Coral, BlockType, ? extends Block> factory, BiFunction<Block, Item.Properties, ? extends BlockItem> blockItemFactory)
        {
