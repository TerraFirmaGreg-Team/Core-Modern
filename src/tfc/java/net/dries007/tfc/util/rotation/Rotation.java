 ...
 * <p>
 * One primary instance of {@link Tickable} is meant to be created by a source within a mechanical network.
...
{
    static Tickable of(Direction direction, float initialSpeed)
    {
        return new Tickable() {
